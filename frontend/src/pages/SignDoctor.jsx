...
//                   type="text"
//                   name="username"
//                   className="w-full p-2 border mt-2 mb-3 rounded-[6px]"
...
//             <h6 className="my-3 font-semibold">Professional Information</h6>
...
//             <label className="flex items-start gap-2 my-2 border p-4 rounded-[5px]">
...
//     experience: "",
//     accountType: "doctor",
//     availability: [], // Added to store availability slots
//   });
...
//               type="text"
//               name="fullname"
//               className="w-full p-2 border mt-1 mb-3 rounded-[6px] bg-[#E8F0FE]"
//               placeholder="Enter your full name"
//               value={form.fullname}
//               onChange={handleChange}
//               required
...
//                   type="text"
//                   name="username"
//                   className="w-full p-2 border mt-2 mb-3 rounded-[6px] bg-[#E8F0FE]"
//                   placeholder="Choose a username"
//                   value={form.username}
//                   onChange={handleChange}
//                   required
...
//             <div className="mb-4">
//               <div className="flex flex-col sm:flex-row gap-3 mb-4 p-4 bg-[#E8F0FE] rounded-[6px]">
//                 <select
//                   name="day"
//                   value={newAvailability.day}
//                   onChange={handleNewAvailabilityChange}
//                   className="p-2 border border-gray-300 rounded-[6px] bg-white"
//                 >
...
//                   className="bg-[#286F76] text-white px-4 py-2 rounded-[6px] hover:bg-[#1F5A61] transition-all duration-200"
//                 >
//                   Add
//                 </button>
//               </div>
...
//                     <div
//                       key={index}
//                       className="flex items-center justify-between p-3 mb-2 bg-[#E8F0FE] rounded-[6px]"
//                     >
